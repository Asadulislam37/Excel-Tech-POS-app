...
export const NAV: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: "Brand", href: "/config/brand", phase: 2 },
      { label: "Category", href: "/config/category", phase: 2 },
      { label: "Color", href: "/config/color", phase: 2 },
      { label: "Size / Storage", href: "/config/size", phase: 2 },
      { label: "Outlet", href: "/config/outlet", phase: 3 },
      { label: "Supplier", href: "/config/supplier", phase: 2 },
      { label: "Unit", href: "/config/unit", phase: 2 },
      { label: "Warranty", href: "/config/warranty", phase: 2 },
